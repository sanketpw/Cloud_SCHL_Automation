...
import com.qa.pages.establishment.LeaveStatusReport;
import com.qa.utilities.ExcelReader;
import com.qa.utilities.Utilities;

public class LeaveStatusReportTests extends BaseClass {
	
	LoginPageAdmin loginPage;
	HomePageAdmin homePage;
	Establishment establishment;
	LeaveStatusReport leaveStatusReport;
	...
	public void Leave_Status_Report() throws IOException, Exception {
	
		loginPage = new LoginPageAdmin(driver);
		establishment = new Establishment(driver);
		leaveStatusReport = new LeaveStatusReport(driver);
		...
		//establishment.openLeaveStatusReport();
		driver.findElement(By.linkText("Leave Status Report")).click();
		System.out.println("Leave Status Report");
		
		//leaveStatusReport.ddlStaffType();
		Select ddlStaff = new Select(driver.findElement(By.id("ddlStaffType")));
		ddlStaff.selectByVisibleText("TEACHING");
		System.out.println("Click on ddlStaffType");
		
		//leaveStatusReport.ddlDepartment();
		...
		//leaveStatusReport.ddlEmployee();
		Select ddlEmployee = new Select(driver.findElement(By.id("ddlEmployee")));
		ddlEmployee.selectByVisibleText("Shweta Patel");
		System.out.println("Click on ddlEmployee");
		
		//leaveStatusReport.btnReport();
